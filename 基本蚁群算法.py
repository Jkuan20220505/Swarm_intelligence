...
pheromone_graph = [[1.0 for col1 in range(city_num)] for raw1 in range(city_num)]
...
class TSP(object):
    ...
    def new(self, evt=None):
        ...
        self.best_ant.total_distance = 1 << 31  # 初始最大距离 1<<31=2147483648
        self.iter = 1  # 初始化迭代次数
...
if __name__ == '__main__':
    ...
    # 第一次尝试：迭代次数： 500   最佳路径总距离： 3688
    # 第二次尝试：迭代次数： 501 最佳路径总距离： 3687